...
namespace MyTranslationUIBundle\Translation;
...
class Updater
{
     ...
     */
    public function __construct(\JMS\TranslationBundle\Translation\LoaderManager $loader, \JMS\TranslationBundle\Translation\ExtractorManager $extractor, LoggerInterface $logger, \JMS\TranslationBundle\Translation\FileWriter $writer)
    {
        $this->loader = $loader;
